...
int Convert_Data_GNN(
    TString inName="/scratch/EIC/Events/Allpix2/Allpix2_time3.root", 
    TString outName="/scratch/EIC/Events/Allpix2/Convert_time_GNN.root"
    ) {
    ...
    outputTree->Branch("start_time", &start_time);
    ...
    for (Long64_t i = 0; i < nentries; i++) {
        ...
        for (auto particle: input_particles) {
            ...
            start_time = particle->getGlobalTime();
